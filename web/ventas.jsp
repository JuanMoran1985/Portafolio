    ...
    <body> 
        ...
        <nav>
            <ul class="menu ">
                ...
                <li class="is-active"><a href="ventas.jsp">Ventas</a></li>
                <li><a href="usuarios.jsp">Usuario</a></li>
                <li><a href="reportes.jsp">Reportes</a></li>
            </ul>
        </nav>
        <article>
            <p><button class="button float-right" data-open="agregarUsuario">REGISTRAR VENTA</button></p>
            <div class="reveal" id="agregarUsuario" data-reveal>
                <p class="lead">Registrar venta</p>
